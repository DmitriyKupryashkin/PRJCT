...
{
    /// <summary>
    /// Фримен. AspNetCore.N5SportsStore приближенный к реальности проект NetCore MVC на NCore 2.1 в рамках обучения ASP.NETCORE MVC
    /// </summary>
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //подключение к закрытой папке node_module куда npm какчает bootstrap, обязятельно должна быть после app.UseStaticFiles() чтоб не переносить файлы в wwwroot
